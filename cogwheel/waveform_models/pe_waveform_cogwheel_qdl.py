...
def Phif3hPN_TLN(f, theta):
    ...
    """
    Mc, eta, chi_1, chi_2, kappa1, kappa2, h1, h2, l1, l2 = theta # TODO: Old version takes in M, not Mc # TODO: Include H
    M = Mc / (eta ** (3 / 5))
...
def gen_h0(f, theta, f_ref):
    ...
    Strain (array):
    """
    Mc, eta, _, _, _, _, _, _, _, _, Deff, tc, phic = theta # kappa1, kappa2, h1, h2, l1, l2
    M = Mc / (eta ** (3 / 5))
...
def gen_taylorF2_qdl_polar(f, params, f_ref):
    """
...
def custom_compute_hplus_hcross(f, par_dic, *_):
    ...
    # wf_params ordering: ['Mc', 'eta', 'chi_1', 'chi_2', 'kappa1', 'kappa2', 'h1', 'h2', 'l1', 'l2', 'Deff', 'tc', 'phic', 'iota', 'f_ref']
