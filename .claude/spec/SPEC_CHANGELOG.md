...
- `0.14.0` (2026-07-20): Build 8a surrogate speed layer: new public module
...
- `0.13.0` (2026-07-20): Build 7b saddle integration: the interim negative-parity refusals are
...
- `0.12.0` (2026-07-19): Negative-parity (macro-saddle) engine branch (Build 6): saddle-capable
...
- `0.11.0` (2026-07-19): Build 7a engine hardening: runtime index-theorem census guard (F012
...
- `0.10.0` (2026-07-18): SACR-C channel construction (Build 3f): switched-analytic saddle
...
- `0.9.0` (2026-07-18): Candidate/fiducial ratio layer (Build 3g): lattice-snapped memoized
...
- `0.8.0` (2026-07-18): Microlensed sampling layer (Build 4): `LensedIASPrior` (sampled reduced
...
- `0.7.0` (2026-07-18): Marginalized lensed likelihood (Build 5): `LensedMarginalizedExtrinsicLikelihood`
...
- `0.6.0` (2026-07-18): Batched engine fast path (Build 3c): new public `operator.F_op_grid`
...
- `0.5.0` (2026-07-17): Microlensed likelihood fast path (Builds 3/3b): coarse full-cluster
