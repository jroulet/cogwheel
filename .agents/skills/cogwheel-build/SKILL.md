...
Use the provider-appropriate launcher:
- `.opencode/build "@.claude/handoff/<brief>.md" --approval-dir /tmp/<slug>_approval`
- `.codex/build "@.claude/handoff/<brief>.md" --approval-dir /tmp/<slug>_approval`
